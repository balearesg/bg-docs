System.register(["@beyond-js/backend@0.1.4/client", "@beyond-js/kernel@0.1.8/bundle"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsBackend014Client) {
      dependency_0 = _beyondJsBackend014Client;
