...
export function Home() {
	return (
		<div className="home">
			...
			<p>
				En esta documentacion vas a poder encontrar informacion sobre los procesos
				desarrollados en Baleares Group, asi como la documentacion de los proyectos que
				usamos en el dia a dia a la hora de hacer aplicaciones de calidad
			</p>
			...
			<div className="card__container">
				...
				<Card title="BG Auth" href="/auth-instalation">
					Documentacion para la integracion del objeto session del bg-auth en
					aplicaciones.
				</Card>
				<Card title="BG Auth" href="/auth-instalation">
